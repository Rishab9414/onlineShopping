...
@section('page-subtitle', 'Manage product materials')
...
@section('content')
<x-master-crud
    :base-url="route('admin.masters.materials.index')"
    module="materials"
    :columns="[['label'=>'Name'],['label'=>'Description'],['label'=>'Status']]"
>
    <x-slot:form>
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="sm:col-span-2"><label class="block text-sm font-medium text-slate-700 mb-1">Material Name *</label><input name="name" required class="admin-input text-sm"></div>
