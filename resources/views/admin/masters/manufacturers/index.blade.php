...
@section('content')
<x-master-crud
    :base-url="route('admin.masters.manufacturers.index')"
    module="manufacturers"
    :columns="[['label'=>'Name'],['label'=>'GST Number'],['label'=>'Email'],['label'=>'Phone'],['label'=>'Contact Person'],['label'=>'Status']]"
>
    <x-slot:form>
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div class="sm:col-span-2"><label class="block text-sm font-medium text-slate-700 mb-1">Manufacturer Name *</label><input name="name" required class="admin-input text-sm"></div>
            <div><label class="block text-sm font-medium text-slate-700 mb-1">GST Number</label><input name="gst_number" class="admin-input text-sm"></div>
            ...
            <div><label class="block text-sm font-medium text-slate-700 mb-1">Contact Person</label><input name="contact_person" class="admin-input text-sm"></div>
